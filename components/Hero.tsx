        ...
        <nav className="nav hidden lg:block">
          <ul className="mt-16 w-max">
            <li>
              ...
              >
                <span
                  className={`nav-indicator mr-4 h-px transition-all duration-300 ease-in-out ${activeSection === 'about'
                      ? 'w-16 bg-neutral-50'
                      : 'w-8 bg-neutral-600'
                    } group-hover:w-16 group-hover:bg-neutral-50`}
                />
                <span className="nav-text text-s font-bold uppercase tracking-widest group-hover:text-neutral-50">
                  About
                </span>
              </a>
            </li>
            <li>
              ...
              >
                <span
                  className={`nav-indicator mr-4 h-px transition-all duration-300 ease-in-out ${activeSection === 'projects'
                    ? 'w-16 bg-neutral-50'
                    : 'w-8 bg-neutral-600'
                    } group-hover:w-16 group-hover:bg-neutral-50`}
                />
            ...
            <li>
              <a
                className={`group flex items-center py-3 ${activeSection === 'contact' ? 'text-neutral-50' : 'text-neutral-500'
                  }`}
                href="#contact"
              >
                <span
                  className={`nav-indicator mr-4 h-px transition-all duration-300 ease-in-out ${activeSection === 'contact'
                    ? 'w-16 bg-neutral-50'
                    : 'w-8 bg-neutral-600'
                    } group-hover:w-16 group-hover:bg-neutral-50`}
                />
